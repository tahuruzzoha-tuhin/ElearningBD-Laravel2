...
export default {
    data() {
        return {
            columns: [
                ...
                { title: 'Company name', field: 'name', sortable: true },
    ...
    computed: {
        ...mapGetters('ContactCompaniesIndex', ['data', 'total', 'loading', 'relationships']),
    },
    watch: {
        query: {
            handler(query) {
    ...
    methods: {
        ...mapActions('ContactCompaniesIndex', ['fetchData', 'setQuery', 'resetState']),
    }
}
</script>
