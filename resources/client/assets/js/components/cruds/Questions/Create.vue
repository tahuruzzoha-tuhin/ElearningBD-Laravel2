...
export default {
    ...
    methods: {
        ...mapActions('QuestionsSingle', ['storeData', 'resetState', 'setQuestion_id', 'setTest', 'setQuestion_text', 'setQuestion_image', 'destroyQuestion_image', 'destroyUploadedQuestionImage', 'setQuestion_file', 'destroyQuestion_file', 'destroyUploadedQuestionFile', 'fetchTestsAll']),
        updateQuestion_id(e) {
