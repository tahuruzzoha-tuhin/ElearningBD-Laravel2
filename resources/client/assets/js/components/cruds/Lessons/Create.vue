...
export default {
    ...
    methods: {
        ...mapActions('LessonsSingle', ['storeData', 'resetState', 'setLesson_id', 'setCourse', 'setTitle', 'setThumbnail', 'destroyThumbnail', 'destroyUploadedThumbnail', 'setShort_text', 'setLong_text', 'setVideo', 'destroyVideo', 'destroyUploadedVideo', 'setPosition', 'setIs_published', 'setIs_free', 'fetchCoursesAll']),
        updateLesson_id(e) {
