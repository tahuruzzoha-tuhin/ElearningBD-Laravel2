...
export default {
    ...
    methods: {
        ...mapActions('CoursesSingle', ['storeData', 'resetState', 'setTeacher', 'setTitle', 'setDescription', 'setPrice', 'setThumbnail', 'destroyThumbnail', 'destroyUploadedThumbnail', 'setIs_published', 'setStudents', 'fetchPermissionsAll', 'fetchUsersAll']),
        updateTeacher(value) {
