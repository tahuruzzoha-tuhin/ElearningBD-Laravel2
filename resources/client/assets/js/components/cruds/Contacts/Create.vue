...
export default {
    ...
    methods: {
        ...mapActions('ContactsSingle', ['storeData', 'resetState', 'setCompany', 'setFirst_name', 'setLast_name', 'setPhone1', 'setPhone2', 'setEmail', 'setSkype', 'setAddress', 'fetchContactcompaniesAll']),
        updateCompany(value) {
