...
export default {
    data() {
        return {
            columns: [
                ...
                { title: 'Phone 1', field: 'phone1', sortable: true },
                { title: 'Phone 2', field: 'phone2', sortable: true },
            ...
            xprops: {
                module: 'ContactsIndex',
                route: 'contacts',
                permission_prefix: 'contact_'
            }
        }
    },
    created() {
    ...
    computed: {
        ...mapGetters('ContactsIndex', ['data', 'total', 'loading', 'relationships']),
    },
    watch: {
        query: {
            handler(query) {
    ...
    methods: {
        ...mapActions('ContactsIndex', ['fetchData', 'setQuery', 'resetState']),
    }
}
</script>
